...
const CafeCard = ({cafe, key}) => {
  if (!cafe) return null; // cafe가 없으면 아무것도 렌더링하지 않음
  const { place_name, address_name, road_address_name } = cafe;

  
  return (
    <div key={key} className="shadow bg-[url(https://www.thinkfood.co.kr/news/photo/202007/88177_114044_267.jpg)] h-full w-[300px] flex flex-col items-center gap-[16px] text-white rounded-[20px]">
