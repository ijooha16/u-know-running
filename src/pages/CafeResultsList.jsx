...
const CafeResultsList = () => {
  return (
    <ContentLayout>
      <div className="bg-[#191970] flex flex-row items-center justify-center p-5 gap-5 w-[960px] overflow-x-auto whitespace-nowrap">
      ...
      <div className="grid grid-cols-3 gap-[30px] bg-orange-200 mx-auto w-fit">
        <ContentBox />
        <ContentBox />
        <ContentBox />
        <ContentBox />
